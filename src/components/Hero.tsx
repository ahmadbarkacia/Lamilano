  ...
  return (
    <section className="relative h-screen overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: 'url(./public/backHero.png?auto=compress&cs=tinysrgb&w=1920)',
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(./public/La_Milano_Cover.png?auto=compress&cs=tinysrgb&w=1920)',
          transform: `translateY(${scrollY * 0.5}px)`,
        }}
      >
